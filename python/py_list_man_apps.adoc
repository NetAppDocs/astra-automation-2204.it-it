...
[role="lead"]
È possibile utilizzare il seguente script per elencare le applicazioni gestite per l'account Astra.


NOTE: Vedere link:../python/python_before.html["Prima di iniziare"] Per un esempio del file di input JSON richiesto.
